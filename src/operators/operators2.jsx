...
const ComparisonGame2 = ({language}) => {
    ...
    const translations = {
        en: {
            ...
            next: "next",
            successMessage: "Great job! eggs are equal to milk!",
            failMessage: "Oops! eggs must equal milk. Try again!"
        },
        ar: {
            ...
            next: "التالي",
            successMessage: "عمل رائع! البيض يساوي الحليب!",
            failMessage: "عذراً! يجب أن يكون البيض مساوياً للحليب. حاول مرة أخرى!"
        }
    };
    ...
    return (
        <div style={{ 
            ...
            {feedback.includes(language === 'ar' ? 'رائع' : 'Great') && 
                <button onClick={() => {navi("/operators3")}}
                    style={{
                        padding: "10px 20px",
                        backgroundColor: "#28a745",
                        color: "white",
