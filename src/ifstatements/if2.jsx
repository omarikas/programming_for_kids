...
const If2 = ({language}) => {
  ...
  const translations = {
    en: {
      ...
      example: `if(redpostionx==bluepositionx && redpositiony>bluepositiony){
      succes();
    ...
    ar: {
      ...
      example: `
      if(redpostionx==bluepositionx && redpositiony>bluepositiony){
      succes();
...
function haveSameTranslation(element1, element2) {
  ...
  {Finish&& <button> <Link to="/ifplayground"> next </Link></button> }
